...
namespace RLPUR.Web
{
    public partial class CommonPur : LocalPage
    {
        /// <summary>
        /// 页面加载
        /// </summary>
        ...
        protected void CreateButton_Click(object sender, EventArgs e)
        {
            ...
            foreach (GridViewRow row in List.Rows)
            {
                ...
                if (rowCheckControl.Checked)
                {
                    ...
                    newRow["PRLQTY"] = Util.ToInt(row.Cells[6].Text.Trim()) - LocalGlobal.GetBomQty(ORDNO.Text.Trim(), row.Cells[1].Text.Trim(), "N");
        ...
        protected void SaveButton_Click(object sender, EventArgs e)
        {
            ...
            using (PurProvider purProvider = new PurProvider())
            {
                try
                {
                    ...
                    cmd.CommandText = purProvider.InsertPRSql(prNo, ORDNO.Text.Trim(), DRAWNO.Text, "N", " ", "一般请购", LocalGlobal.CurrentUserID, dateModel.DateStr, LocalGlobal.CurrentUserID, dateModel.DateStr);
                    cmd.ExecuteNonQuery();
